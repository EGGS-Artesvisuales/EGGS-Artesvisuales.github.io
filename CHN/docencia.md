...
<!-- Título principal -->
<h1 class="titulo">教学</h1>

<h2 class="subtitulo">艺术教学研讨会、项目和经验</h2>

<!-- Párrafo introductorio -->
<p class="parrafo" style="margin-top: 6%;">
  自从 2011 年从智利大学获得学位以来，我有机会在不同的环境和地区任教。我在很小的时候就开始了这项工作，对艺术的热情推动了我的创造性工作。我将教学理解为一个不断交流的过程，在这个过程中，教学人员也从每个研讨会中发现的人物、地点和故事中学习。
</p>

<p class="parrafo">
  每一次的教学经历都是相互学习的实例，丰富了我的艺术实践和理解世界的方式。本页面汇集了其中一些流程：社区研讨会、机构项目、学校科目以及围绕视觉艺术和壁画的特殊项目。
</p>

<!-- Subtítulo de la línea de tiempo -->
<h2 class="subtitulo">时间轴</h2>
  ...
  <div class="timeline">
    ...
    <div class="year" data-year="2025">
      ...
      <div class="entry">
        ...
        <div class="text-container">
          <p>
            与以下机构共同开发的社区壁画讲习班 <strong>智利公司之声</strong>.<br>
            <strong>该项目由Corporación Cultural de La Florida资助 - 文化实体基金 2025（Folio N°7）。</strong>
          </p>
        </div>
        ...
        <div class="text-container">
          ...
          <p>
            <strong>汉斯·阿斯伯格特殊学校</strong>，La Florida。<br>
            适合特殊教育背景的研讨会：视觉调解、协作工作和集体故事的构建。
          </p>
        </div>
      </div>
      ...
      <div class="entry">
        ...
        <div class="text-container">
          <p>
            该过程的第二个领域阶段：社区调解、干预协议和参与式设计的制定。<br>
            <strong>该项目由Corporación Cultural de La Florida资助 - 文化实体基金 2025（Folio N°7）。</strong>
          </p>
        </div>
        ...
        <div class="text-container">
          ...
          <p>
            <strong>JJVV 23-C</strong>，La Florida查孔萨莫拉别墅。<br>
            分阶段的区域工作：社区聆听、主题定义和集体制作。
          </p>
        </div>
        ...
        <div class="text-container">
          ...
          <p>
            <strong>JJVV 24-A</strong>，La Florida阿尔贝托·拉拉吉贝尔别墅。<br>
            壁画设计与实践的社区过程：邻里组织、意象构建、引导执行。
          </p>
        </div>
      </div>
      ...
      <div class="entry">
        ...
        <div class="text-container">
          ...
          <p>
            ...
            由佛罗里达文化公司在 Espacio Los Quillyes 举办的为女孩、男孩和年轻人举办的研讨会。
          </p>
        </div>
      </div>
