...
<p class="parrafo" style="margin-top: 5%;">
  EGGS-Studio 汇集绘画、摄影、壁画以及关于城市、广告、地域与日常生活的视觉介入。你可以在这里浏览作品体系，购买可售版本，并咨询艺术项目或委托创作。
</p>

<div class="button-container">
  <a href="/CHN/tienda.html#impresiones-y-fotografia" class="fancy-button">
    <div class="button-content">
      <img src="/assets/img/pinf-blds-upg-retr-003b.jpg" alt="可购买的艺术微喷与摄影" loading="lazy">
      <p class="title">购买作品</p>
      <p class="subtitle">限量艺术微喷与摄影，签名、编号并附证书。</p>
    </div>
  </a>

  <a href="/CHN/contacto.html" class="fancy-button">
    <div class="button-content">
      <img src="/assets/img/index---gif--accion-en-el-mundo.webp" alt="委托、壁画与项目" loading="lazy">
      <p class="title">委托项目</p>
      <p class="subtitle">壁画、绘画、修复、工作坊、布展与文化项目。</p>
    </div>
  </a>
  ...
  <a href="/CHN/mundo-exterior.html" class="fancy-button">
    <div class="button-content">
      ...
      <p class="subtitle">绘画、摄影、城市介入、社区与内在世界。</p>
    </div>
  </a>
</div>
...
<h2 class="subtitulo">作品地图</h2>

<p class="parrafo">
  网站以一个简洁的策展地图组织：世界的再现、在世界中的行动与内在世界。图表保留概念深度，但不取代主要导航。
</p>
...
<p class="parrafo" style="margin-top: 7%;">
  如果你是第一次来到这里，可以先从商店或主要系列开始。若想理解完整的作品结构，请继续浏览概念地图与三个轴线。
</p>

<a href="/CHN/exhibiciones.html" class="enlace">查看展览与轨迹</a>
