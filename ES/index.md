...
<h2 class="subtitulo">Series destacadas</h2>

<p class="parrafo">
  Entra por una serie clara: cada landing resume el concepto, muestra una imagen guía y deriva a tienda, archivo o productos relacionados.
</p>

<div class="button-container">
  <a href="/ES/serie-pinturas-infectadas.html" class="fancy-button"><div class="button-content"><img src="/assets/img/pinf-blds-upg-retr-003b.jpg" alt="Pinturas Infectadas" loading="lazy"><p class="title">Pinturas Infectadas</p><p class="subtitle">Cuando la pintura se comporta como un organismo.</p></div></a>
  <a href="/ES/serie-paisajes-carretera.html" class="fancy-button"><div class="button-content"><img src="/assets/img/tienda/EGGS-W0008-L01-P5070-F70100.webp" alt="Paisajes de Carretera" loading="lazy"><p class="title">Paisajes de Carretera</p><p class="subtitle">Paisaje, tránsito, velocidad y memoria visual.</p></div></a>
  <a href="/ES/serie-banderas-infectadas.html" class="fancy-button"><div class="button-content"><img src="/assets/img/tienda/EGGS-W0016-L01-P5070-F70100.webp" alt="Banderas Infectadas" loading="lazy"><p class="title">Banderas Infectadas</p><p class="subtitle">Símbolos alterados por pintura, peste e identidad.</p></div></a>
  <a href="/ES/serie-antipublicidad.html" class="fancy-button"><div class="button-content"><img src="/assets/img/boton-antipub.webp" alt="Antipublicidad" loading="lazy"><p class="title">Antipublicidad</p><p class="subtitle">PP Series, Carteles, Piratería Publicitaria e intervención.</p></div></a>
  <a href="/ES/serie-el-colgado.html" class="fancy-button"><div class="button-content"><img src="/assets/img/tienda/EGGS-W0053-L01-P110160-F120170.webp" alt="El Colgado" loading="lazy"><p class="title">El Colgado</p><p class="subtitle">Fotografía, rito, cuerpo suspendido y territorio.</p></div></a>
</div>
...
flowchart LR
  ...
  click pinturas "/ES/serie-pinturas-infectadas.html" "Ver Pinturas Infectadas"
  click colgado "/ES/serie-el-colgado.html" "Ver El Colgado"
