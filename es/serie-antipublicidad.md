...
description: "Landing de Antipublicidad: PP Series, Serie Carteles y Piratería Publicitaria."
permalink: /es/serie-antipublicidad.html
en_url: /en/anti-advertising-series.html
mpd_url: /mpd/serie-antipublicidad.html
zh_url: /chn/serie-antipublicidad.html
keywords: "Antipublicidad, PP Series, carteles, piratería publicitaria, Esteban Garnica"
mermaid: true
---

<h1 class="titulo">Antipublicidad</h1>
<h2 class="subtitulo">Intervenir la publicidad desde dentro de su propio lenguaje.</h2>

<figure class="imagen-con-caption">
  <img src="/assets/img/boton-antipub.webp" alt="Antipublicidad EGGS-Studio" loading="lazy">
  <figcaption>Antipublicidad reúne PP Series, Serie de los Carteles y Piratería Publicitaria.</figcaption>
</figure>

<section class="parrafo">
  <p><strong>Antipublicidad</strong> es una línea de trabajo sobre soportes, códigos y promesas del sistema publicitario. No opera como un producto único: funciona como categoría de intervención visual y crítica urbana.</p>
...
<div class="button-container">
  ...
  <a class="fancy-button" href="/es/tienda.html"><div class="button-content"><p class="title">Tienda</p><p class="subtitle">Obras y ediciones disponibles.</p></div></a>
</div>
...
flowchart LR
  ...
  A --> C[Serie Carteles]
  A --> P[Piratería Publicitaria]
  A --> M[Modelos de intervención]
  A --> T[Tienda / publicaciones]
</script>
</div>
