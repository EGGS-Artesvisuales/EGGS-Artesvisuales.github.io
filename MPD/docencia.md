...
<!-- Título principal -->
<h1 class="titulo">Kimeltun</h1>

<h2 class="subtitulo">Talleres, programas ka az-kimeltun ñi zugu</h2>
...
<h2 class="subtitulo">Txipantu ñi rüpü</h2>
  ...
  <div class="timeline">
    ...
    <div class="year" data-year="2016">
      <div class="entry">
        ...
        <div class="text-container">
          <div class="az">
            <img src="/assets/img/docencia-2016-graff-licptealto.jpg" alt="Az del taller" loading="lazy">
          </div>
          <p>
      ...
      <div class="entry">
        ...
        <div class="text-container">
          <div class="az">
            <img src="/assets/img/docencia-2016-pace-usach.jpg" alt="Az del taller" loading="lazy">
          </div>
          <p>
